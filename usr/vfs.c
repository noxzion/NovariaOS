...
void vfs_init(void) {
    ...
    vfs_create("/bin/Nutils/cat.bin", "# Cat\n", 6);
    vfs_create("/bin/Nutils/echo.bin", "# Echo\n", 7);
    vfs_create("/bin/Nutils/mount.bin", "# Mount\n", 8);
    vfs_create("/bin/Nutils/doas.bin", "# Doas\n", 7);
    
    vfs_create("/lib/n/crypto.bin", "# Crypto\n", 9);
    vfs_create("/lib/n/io.bin", "# I/O\n", 6);
    vfs_create("/lib/n/sys.bin", "# System\n", 9);
}
